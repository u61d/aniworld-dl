...
class api:
    ...
    def __init__(self, name, ownerid, version, hash_to_check):
        if len(ownerid) != 10:
            print(
                "Visit https://keyauth.cc/app/, copy Pthon code, and replace code in main.py with that"
            )
            time.sleep(3)
            os._exit(1)
    ...
    def __do_request(self, post_data):
        try:
            ...
            if (
                post_data["type"] == "log"
                or post_data["type"] == "file"
                or post_data["type"] == "2faenable"
                or post_data["type"] == "2fadisable"
            ):
